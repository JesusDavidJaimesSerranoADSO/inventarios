            ...
            <?php
                ...
                if($categorias -> rowCount() > 0){
                    ...
                    foreach($categorias as $opcion){
                        echo '<a href="index.php?vista=producto_category&categoria_id='.$opcion['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$opcion['categoria_nombre'].'</a>';
                    }
                }else{
        ...
        if($categoria -> rowCount() > 0){
            $categoria = $categoria -> fetch();
             echo '
                ...
                <p class="has-text-centered pb-6" >'.$categoria['categoria_ubicacio'].'</p>
             ';

            if(isset($_GET['producto_id_del'])){
                require_once("./php/pruducto_eliminar.php");
            }
            ...
            $url = "index.php?vista=producto_category&categoria_id=$categoria_id&page=";
            $registro = 15;
            $busqueda = "";
